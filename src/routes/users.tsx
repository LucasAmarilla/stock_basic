...
import { deleteUser, getUsersList } from "~/data/lib/users";
...
export default function Users() {
  ...
  const [result, { refetch }] = createResource(
    ...
    ([currentPage, currentSearch]) =>
      getUsersList(currentPage, 10, currentSearch),
  );
  ...
  //     try {
  //       await deleteUser(id);
  //       await revalidate(getUsersList.keyFor(page(), 10, submittedSearch()));
  //       await refetch();
                ...
                <table class="min-w-full">
                  <thead class="bg-gray-50">
                    <tr class="text-sm uppercase tracking-wide text-gray-500">
                      ...
                      <th class="px-6 py-4 text-left font-semibold">Admin</th>
                      <th class="px-6 py-4 text-left font-semibold">
                        Opciones
                      </th>
                    </tr>
